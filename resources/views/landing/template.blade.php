        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="{{asset('index.html')}}"><img src="image/Logo.png" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="about.html">Kamar</a></li>
                            <li class="nav-item"><a class="nav-link" href="accomodation.html">Fasilitas</a></li>
            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h2>HOTEL CERIA</h2>
						<p>HOTEL CERIA<br> tapi yang bikinnya ga ceria setres.</p>
					</div>
				</div>
            </div>
